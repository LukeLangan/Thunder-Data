...
ShotDist.C3.A=C3.A.Att/(FGA.A)
ShotDist.TwoPT.A=TwoPT.A.Att/(FGA.A)
ShotDist.NC3.A=NC3.A.Att/(FGA.A)
ShotDist.C3.B=C3.B.Att/(FGA.B)
ShotDist.TwoPT.B=TwoPT.B.Att/(FGA.B)
ShotDist.NC3.B=NC3.B.Att/(FGA.B)
